			...
			<!-- 	<li class="grey dropdown-modal">
							...
							<ul class="dropdown-menu dropdown-navbar">
								<li>
									<a href="#" class="clearfix">
										<img src="<?php  public_url() ?>/backend/assets/images/avatars/avatar5.png" class="msg-photo" alt="Alex's Avatar" />
				...
				<li class="light-blue dropdown-modal">
					<a data-toggle="dropdown" href="#" class="dropdown-toggle">
						<?php if($jobseeker_info->sImage==""){?>
						<img class="nav-user-photo" src="<?php  echo base_url('template/backend/assets/images/avatars/profile-pic.jpg'); ?>" alt="Jason's Photo" />
						<?php
						}else{?>
						<img class="nav-user-photo" src="<?php  echo base_url('uploads/jobseeker/'.$jobseeker_info->sImage); ?>" alt="Jason's Photo" />
						<?php

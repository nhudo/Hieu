									...
									<tr>
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												...
												<a class="green" href="<?php echo admin_url('job/edit/'.$value->id); ?>" onclick="return confirmAction();">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>

												<a class="red" href="<?php echo admin_url('job/delete/'.$value->id); ?>" onclick="return confirmAction();">

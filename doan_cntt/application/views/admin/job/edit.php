...
<?php $this->load->view('admin/caidat') ?>
						...
						<div class="widget-main">
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12 ">
											<input type="text" name="email"  value="<?php echo $info->sEmail; ?>" id="form-input-readonly"  placeholder="sangtran@gmail.com" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="form-input-readonly-3" name="stel" value="<?php echo $info->sPhone; ?>" placeholder="0984407771" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
								<div class="space space-8"></div>
						...
						<div class="widget-main">
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="name"  name="name" placeholder="Họ và tên" value="<?php echo $info->sUserName; ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div class="control-group">
								...
								<div class="radio">
									<label>
										<input name="gender" type="radio" <?php if($info->iGender==1){echo 'checked="checked"';}  ?> value="1" class="ace">
										<span class="lbl"> Nam</span>
									</label>
								</div>
								<div class="radio">
									<label>
										<input name="gender" type="radio" <?php if($info->iGender==0){echo 'checked="checked"';} ?> value="0" class="ace">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="input-group">
											<input class="form-control date-picker" id="date_birth" name="date_birth" value="<?php echo $info->dBirthday; ?>" type="text" data-date-format="mm-dd-yyyy">
					...
					<div class="widget-body">
						<div class="widget-main">
							...
							<div>
								...
								<br />
								<select class="chosen-select form-control" id="form-field-select-3"  name="scity" data-placeholder="<?php if(!$jobseeker_info){echo 'không tồn tại';}else{echo $jobseeker_info->sCityName;}  ?>">
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="adress" name="adress"  placeholder="Địa chỉ" value="<?php echo $info->sAddress; ?>"  class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
								<div class="space space-8"></div>

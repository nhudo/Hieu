					...
					<table id="simple-table" class="table  table-bordered table-hover">
							...
							<form action="" method="post" enctype="multipart/form-data">
								...
								<td>
									<div class="hidden-sm hidden-xs btn-group">
										<a href="<?php echo admin_url('admin/edit/'.$value->id); ?>"  onclick=" return confirmedit()">	
											<button id="id-btn-dialog2" class="btn btn-xs btn-info" >
												<i class="ace-icon fa fa-pencil bigger-120"></i>
											</button>
										</a>
										<a href="<?php echo admin_url('admin/delete/'.$value->id); ?>" onclick=" return confirmAction()" >
									...
									<div class="hidden-md hidden-lg">
										<div class="inline pos-rel">
											...
											<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
												...
												<li>
													<a href="<?php echo admin_url('admin/delete/'.$value->id); ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
														<span class="red">
															<i class="ace-icon fa fa-trash-o bigger-120"></i>
														</span>
													</a>
						...
						<thead>
							<tr>
								<th class="center">
									<label class="pos-rel">
									<a href=" <?php echo admin_url('admin/delete_check'); ?>"  onclick="return confirmAction();">	
										<button class="btn btn-xs btn-danger">
												<i class="ace-icon fa fa-trash-o bigger-120"></i>
										</button>
									</a>	

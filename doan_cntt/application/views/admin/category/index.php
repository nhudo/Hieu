				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<div>
								<label for="form-field-1" class="control-label bolder blue">Tên danh mục<span class="red"><?php echo form_error('name'); ?></span></label>
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="name" name="name" placeholder="Tên danh mục" value="<?php if(isset($info)){ echo $info->sNewsCategory;} else{echo '';} ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
									<label for="form-field-select-3" class="control-label bolder blue">Danh mục con</label>

									<br />
									<select class="chosen-select form-control" id="form-field-select-3" name="paren" <?php if(($info->iParentID)!=0){?>
									data-placeholder="<?php
										echo $info2->sNewsCategory;?>"
									<?php } ?>   >
							...
							<div>
								<label for="form-field-1" class="control-label bolder blue">Mô tả</label>
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
										<textarea placeholder="Mô tả" class="col-md-12 col-xs-12" name="conten" id="conten"  rows="4" ><?php if(isset($info)){ echo $info->sCaption;} else{echo '';} ?></textarea>
										</div>
									</div>
								</div>
									...
									<tr>
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												...
												<a class="green" href="<?php echo admin_url('category/edit/'.$value->id); ?>" onclick="return confirmedit();">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>

												<a class="red" href="<?php echo admin_url('category/delete/'.$value->id); ?>" onclick="return confirmAction();">

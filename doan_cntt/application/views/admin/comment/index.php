						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th>Username</th>
									<th>Email</th>
									<th class="hidden-480">Tên bài viết</th>
									<th class="hidden-480">Người reply</th>
									<th class="hidden-480">
							...
							<?php if(!empty($list)){
								...
								<tr>
									...
									<td>
										<?php echo $value->sUserName; ?>
									</td>
								
									<td ><?php  echo $value->sEmail;?></td>

									<td><a href="<?php echo base_url('post/read/'.$value->iPost_ID); ?>"><?php if($info[$i-1]){echo $info[$i-1]->sNewsTitle;}else{echo 'Không tồn tại';}?></a></td>
									<td > <?php if(!empty($info_admin[$i-1])){echo $info_admin[$i-1]->sUserName;}else{echo 'Chưa trả lời';}  ?></td>
									<td > <?php if(!empty($info_reply[$i-1])){echo $info_reply[$i-1]->sDatepost;}  ?></td>
									<td > <?php if($value->iStatus==0){echo 'Chưa đọc';}else{echo 'Đã xem';}  ?></td>
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="green" onclick="return confirmedit();" href="<?php echo admin_url('comment/reply/'.$value->id); ?>">
												<i class="ace-icon fa fa-pencil bigger-130"></i>
											</a>

											<a class="red" href="<?php echo admin_url('comment/delete/'.$value->id); ?> " onclick="return confirmAction();">

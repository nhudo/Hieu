						...
						<div class="widget-main">
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="website" name="website"  placeholder="Website" value="<?php echo $info->sWebsite; ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
								<div class="space space-8"></div>
						...
						<div class="widget-main">
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="scomname"  name="scomname" placeholder="Tên công ty" value="<?php echo $info->sComName; ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="saddress" name="saddress" placeholder="Địa chỉ" value="<?php echo $info->sAddress;?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="stel" name="stel" placeholder="Số điện thoại" value="<?php echo $info->sTel; ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
						...
						<div class="widget-main">
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
										<textarea name="sprofile" id="sprofile" cols="30" rows="6" class="col-md-12 col-xs-12"  placeholder="Sơ lược về công ty"><?php echo $info->sProfile;?></textarea>
										</div>
									</div>
								</div>
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="sfax" name="sfax" placeholder="Fax" value="<?php echo $info->sFax; ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
						...
						<div class="widget-main">
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="scontactname" name="scontactname" placeholder="Thông tin người liên hệ" value="<?php echo $info->sContactName; ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="semailcontact" name="semailcontact" placeholder="Email" value="<?php echo $info->sContactEmail;?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
							...
							<div>
								...
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<div class="input-group col-md-12 col-xs-12">
											<input type="text" id="snumecontact" name="snumecontact" placeholder="Số điện thoại" value="<?php echo $info->sMobile; ?>" class="col-md-12 col-xs-12">
										</div>
									</div>
								</div>
					...
					<div class="widget-body">
						<div class="widget-main">
							...
							<div class="control-group">
								...
								<div class="radio">
									<label>
										<input name="statust" id="statust" type="radio" value="1" <?php if($info->iStatus==1){echo 'checked="checked"';} ?> class="ace">
								...
								<div class="radio">
									<label>
										<input name="statust" id="statust" <?php if($info->iStatus==2){echo 'checked="checked"';} ?> type="radio" value="2" class="ace">
										<span class="lbl"> Víp</span>
									</label>
								</div>	
								<div class="radio">
									<label>
										<input name="statust" id="statust" <?php if($info->iStatus==3){echo 'checked="checked"';} ?> type="radio" value="3" class="ace">

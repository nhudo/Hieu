						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th>Email</th>
									<th class="hidden-480">Người liên hệ</th>
							...
							<?php if(!empty($list)){
								...
								<tr>
									...
									<td><?php echo $value->sContactName; ?></td>

									<td > <?php echo $value->sTel; ?></td>
									<td > <?php echo $value->sAddress; ?></td>
									<td > <?php echo $value->sUpdate; ?></td>
									<td > <?php if($value->iStatus==1){ echo '<span class="label label-sm label-warning">Bình thường</span>';} else if($value->iStatus==2){ echo '<span class=" label label-sm label-inverse arrowed-in">Vip</span>';} else{echo '<span class="label label-sm label-success">Block</span>';}; ?></td>
									
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="green" onclick="return confirmAction();" href="<?php echo admin_url('employer/edit/'.$value->id); ?>">
												<i class="ace-icon fa fa-pencil bigger-130"></i>
											</a>

											<a class="red" href="<?php echo admin_url('employer/delete/'.$value->id); ?> " onclick="return confirmAction();">
